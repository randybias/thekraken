...
export function buildManagerPrompt(
  ...
  const sections: string[] = [
    ...
    "record to $KRAKEN_TEAM_DIR/outbound.ndjson. The dispatcher's outbound",
    'poller picks it up and posts to Slack:',
    ...
    '(Set THREAD to "" for a top-of-channel post.) Use this for cross-channel',
    'announcements only — your normal in-thread reply still goes through the',
    'standard manager response, not this file.',
    '',
