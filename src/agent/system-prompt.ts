...
export function buildManagerPrompt(
  ...
  const sections: string[] = [
    ...
    '  signals-in.ndjson and posts task_started / progress_update / task_completed /',
    '  task_failed updates to Slack on your behalf.',
    '- DO NOT poll signals-in yourself. DO NOT wait for the dev team to finish',
    ...
    '- You may commission MULTIPLE dev teams in parallel from a single turn if',
    '  the user asked for multiple things — each gets its own taskId, each runs',
    '  independently.',
    '',
    '### When in doubt',
